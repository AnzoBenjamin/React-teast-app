...
function Transactions(){
    ...
    return(
        <>
            ...
            <TitleCard title="Recent Notifications" topMargin="mt-2" TopSideButtons={<TopSideButtons applySearch={applySearch} applyFilter={applyFilter} removeFilter={removeFilter}/>}>
